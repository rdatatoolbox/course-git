## :mortar_board: Introduction to git <img src="img/git-logo.png" height="120" align="right"/>

[![License: CC
BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgreen.svg)](https://choosealicense.com/licenses/cc-by-4.0/)


Code used to create the online presentation **Introduction to git** available at:
[**rdatatoolbox.github.io/course-git**](https://rdatatoolbox.github.io/course-git)
...
[`DESCRIPTION`](https://github.com/rdatatoolbox/course-git/blob/main/DESCRIPTION)
file.
...
[`index.Rmd`](https://github.com/rdatatoolbox/course-git/blob/main/index.Rmd) 
